...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FinancialAidApplication.presenting'
        db.delete_column(u'finaid_financialaidapplication', 'presenting')


    def backwards(self, orm):
        # Adding field 'FinancialAidApplication.presenting'
        db.add_column(u'finaid_financialaidapplication', 'presenting',
